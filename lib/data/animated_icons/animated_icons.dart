...
///
/// The available icons are specified in [CustomAnimatedIcons].
///
/// {@tool sample}
///
/// ```dart
...
class CustomAnimatedIcon extends StatelessWidget {
  ...
  /// The icon to display. Available icons are listed in [CustomAnimatedIcons].
...
class _AnimatedIconPainter extends CustomPainter {
  ...
  void paint(ui.Canvas canvas, Size size) {
    ...
    for (_PathFrames path in paths) path.paint(canvas, color, uiPathFactory, clampedProgress);
  }
